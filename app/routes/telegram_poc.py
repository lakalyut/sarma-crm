...
iOS) до того, как строить что-либо поверх. Тестовый бот, не прод. Проверка
подписи — в app/telegram_auth.py (общий модуль с Этапа 2, используется и
мини-аппом амбассадора), см. ROADMAP.md, горизонт 13.
"""
